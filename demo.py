...
def drawCaption(img, caption):
    ...
    # define a font
    fnt = ImageFont.truetype('/usr/share/fonts/truetype/liberation/LiberationSerif-Bold.ttf', 50)
...
if __name__ == "__main__":
    ...
    if len(captions_list) > 0:
        ...
        # Build ST-CSGAN and load the model
        ...
        with tf.Session(config=config) as sess:
            with tf.device("/gpu:%d" % cfg.GPU_ID):
                ...
                while count < num_embeddings:
                    ...
                    # randomness from noise z and conditioning variables.
